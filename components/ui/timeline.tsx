...
export function Timeline({ data, title = "Changelog from my journey", description, className }: TimelineProps) {
  ...
  return (
    <div
      className={`w-full bg-background font-sans md:px-10 ${className ?? ""}`}
      ref={containerRef}
    >
